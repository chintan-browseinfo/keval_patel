...
class Aadhar(models.Model):
	...
	def create(self,vals):
		...
		#v=self.env['res.partner'].search([('name','=',i)])


		#print "=======================vvvvvvvvv=================",v
		#if i  == self.env['res.partner'].search([('name','=',len(vals.get('Aadhar_id')]):

			#raise UserError(_('Aadhar id already there enter some other number'))
